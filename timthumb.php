...
if(! defined('MEMORY_LIMIT') )				define ('MEMORY_LIMIT', '1000M');							// Set PHP memory limit
...
if(! defined('WEBSHOT_XVFB_RUNNING') )	define ('WEBSHOT_XVFB_RUNNING', true);			//ADVANCED: Enable this if you've got Xvfb running in the background.
